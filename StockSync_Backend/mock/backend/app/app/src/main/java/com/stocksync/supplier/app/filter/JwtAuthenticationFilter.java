package com.stocksync.supplier.app.filter;
...
import com.stocksync.supplier.app.service.impl.CustomUserDetailsService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private static final List<String> SKIPPED_PATHS = List.of(
            ...
            "/api/v1/stocksync-userservice/register", // registration path
            "/actuator",
            "/v3/api-docs",
            "/swagger-ui"
